...
public class ZakladneMatematickeOperacie {
    public static void main(String[] args) {
        ...
        // namiesto %2.f co repzrezentuje zaokruhlenie na 2 desatinne cisla mozeme pouzit ine cislo, napr %1.f
        // co zaokruhli cislo v konzole na 1 desat. miesto
        System.out.printf("\nVýsledkom odčitania hodnôt %.2f a %.2f je %.2f ", cislo1, cislo2, odcitanie);
