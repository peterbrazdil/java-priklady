...
public class ArrayListPriklad {
    public static void main(String[] args) {
        ...
        List<String> dynamickePoleTextov = new ArrayList<String>();
        ...
        // Scenar c.3 - Ukazka na ArrayList naplnenim iba ciselnych udajov, teda s rovnakymi typmi
        // Dynamicke pole s cislami mozeme vytvorit iba pouzitim objektu Integer, Double, Float, Boolean..(velke prve pismeno)
        ...
        System.out.println("\nVýpis obsahu dynamickeho pola cisel cez for each");
