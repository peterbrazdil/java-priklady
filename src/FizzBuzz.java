...
pričom nahrádzajú každé číslo deliteľné tromi slovom "fizz" a každé číslo deliteľné piatimi slovom "buzz".
        ...
        Čísla deliteľné oboma sa nahrádzajú slovami fizz buzz. Hráč, ktorý zaváha alebo urobí chybu je vylúčený z hry.
        ...
        Hint: || reprezentuje OR (alebo), to znamena, ze moze platit jedna podmienka alebo druha
        pokracovanie:&& reprezentuje AND (a) to znamena, ze musi platit jedna podmienka a zaroven druha
 */
